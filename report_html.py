...
# Reporting Log Analysis with Web Application
#
...
<html lang="pt-br">
  <head>
    <title>Udacity Project - Log Analysis Report</title>
    <style>
  ...
  <body>
    ...
    <ol>
      ...
      <li>Who is the most popular authors of the time?
        <table>
          <thead>
            <tr>
...
# HTML for authors name and number of views
QUESTION2 = '''<tr>
              <td>{0}</td>
              <td>{1}</td>
            </tr>'''
